...
def parse_args():
	...
	## Others
	parser.add_argument("--dataset_name", type=str, default="twitter16")
	parser.add_argument("--data_root", type=str, default="/mnt/hdd1/projects/BiGCN/dataset/processedV2")
...
def main(args, obj):
	if args.flatten:
		treePath = "{}/{}/data.TD_RvNN.vol_5000.flatten.txt".format(args.data_root, obj)
		savePath = "{}/{}flattengraph".format(args.data_root, obj)
	else:
		treePath = "{}/{}/data.TD_RvNN.vol_5000.txt".format(args.data_root, obj)
		savePath = "{}/{}graph".format(args.data_root, obj)
	...
	#labelPath = "{}/{}/{}_label_All.txt".format(args.data_root, obj, obj)
	labelPath = "{}/{}/data.label.txt".format(args.data_root, obj)
